...
public class TransactionAdviceConfig {
     ...
     * 定义切点路径
     */
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.com.fh.service.impl.*.*(..))";
    ...
    public TransactionInterceptor TxAdvice() {
        ...
        // 设置事务的传播特性（存在事务则挂起该事务，执行当前逻辑，结束后再恢复上下文事务）
        ...
        txMap.put("batch*", transactionAttribute1);
        txMap.put("save*", transactionAttribute1);
        txMap.put("queryPayStatus*", transactionAttribute1);
        txMap.put("*", transactionAttribute2);
